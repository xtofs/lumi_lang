...
static Value* _fn_2(Value* _env, Value* _arg) {
    ...
    if (_t1) {
        ...
        rc_dec(b);  /* drop b */
        Value* _t3 = alloc_con(TAG_FALSE, 0);
        _t2 = _t3;
    }
    return _t2;
}
...
Value* lumi_main(void) {
    Value* _t1 = lumi_str("and True  True  = ");
    Value* _t2 = print(_t1);
    Value* _sl3 = _t2;
    Value* _t3 = apply(and, lumi_bool(1));
    ...
    Value* _t6 = print_nl();
    Value* _sn3 = _t6;
    Value* _t7 = lumi_str("and True  False = ");
    Value* _t8 = print(_t7);
    Value* _sl2 = _t8;
    Value* _t9 = apply(and, lumi_bool(1));
    ...
    Value* _t12 = print_nl();
    Value* _sn2 = _t12;
    Value* _t13 = lumi_str("and False True  = ");
    Value* _t14 = print(_t13);
    Value* _sl1 = _t14;
    Value* _t15 = apply(and, lumi_bool(0));
    ...
    Value* _t18 = print_nl();
    Value* _sn1 = _t18;
    Value* _t19 = lumi_str("and False False = ");
    Value* _t20 = print(_t19);
    Value* _sl0 = _t20;
    Value* _t21 = apply(and, lumi_bool(0));
...
int main(void) {
    lumi_runtime_init();
    and = lumi_global(lumi_and());
    
    Value* _result = lumi_main();
    rc_dec(_result);
    
    lumi_release_global(and);
    return 0;
}
